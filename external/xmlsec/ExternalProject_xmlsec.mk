...
$(call gb_ExternalProject_get_state_target,xmlsec,build) :
	...
	$(call gb_ExternalProject_run,build,\
		cscript /e:javascript configure.js crypto=mscng xslt=no iconv=no static=no \
			...
			cflags="-arch:SSE $(SOLARINC) -I$(VCPKG_DIR)/include -I$(WORKDIR)/UnpackedTarball/libxml2/include -I$(WORKDIR)/UnpackedTarball/icu/source/i18n -I$(WORKDIR)/UnpackedTarball/icu/source/common" \
		&& nmake \
	,win32)
