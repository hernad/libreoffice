...
DLLS=
DLLS+=" expat.dll"
DLLS+=" boost_locale-vc142-mt-$BOOST_ARCH-1_72.dll"
DLLS+=" boost_filesystem-vc142-mt-$BOOST_ARCH-1_72.dll"
DLLS+=" boost_iostreams-vc142-mt-$BOOST_ARCH-1_72.dll"
# BOOST dependencies
DLLS+=" zlib1.dll bz2.dll lzma.dll zstd.dll"

#DLLS+=" icuin65.dll icuuc65.dll icudt65.dll"

DLLS+=" libpq.dll libiconv.dll libcharset.dll"
DLLS+=" libxml2.dll"
