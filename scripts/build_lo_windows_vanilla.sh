...
#64bit
#BUILD_ARCH=x64 ENVARS_ONLY=0 MAKE_ONLY=0 PARALLELISM=12 scripts/build_lo_windows_vanilla.sh
...
#  BOOST_NODEFAULT_SUFIX="vc142-mt-x64-1_72.lib"
  JAVA_DIR=/cygdrive/c/AdoptOpenjdk/jdk-11
